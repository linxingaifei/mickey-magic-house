...
APP_DIR="/etc/mickey-v2ray"
WEB_DIR="/www/mickey-v2ray"
CGI_SCRIPT="/www/cgi-bin/mickey-v2ray-api"
...
prepare_dirs() {
    echo "[2/5] 初始化目录..."
    mkdir -p "$APP_DIR" "$WEB_DIR" /www/cgi-bin
...
main() {
    ...
    echo ""
    echo "✅ 安装完成"
    echo "Web 面板地址: http://$(uci get network.lan.ipaddr 2>/dev/null || echo 192.168.1.1)/mickey-v2ray/"
}
